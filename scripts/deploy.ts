...
async function deployContracts() {
    ...
    console.log(`OpynPerpVault deployed at ${opynPerpVault.address}.`)
    ...
    console.log(`ShortOTokenActionWithSwap deployed at ${shortOTokenActionWithSwap.address}.`)
...
async function setupOwnership({
    ...
    console.log(`OpynPerpVault ownership transferred to ${newOwnerAddress}.`)

    // transfer ShortOTokenActionWithSwap ownership
    await shortOTokenActionWithSwap.transferOwnership(newOwnerAddress)

    console.log(`ShortOTokenActionWithSwap ownership transferred to ${newOwnerAddress}.`)
}
